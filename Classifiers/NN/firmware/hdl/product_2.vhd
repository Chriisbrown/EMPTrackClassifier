...
architecture behav of product_2 is 
    ...
    signal grp_fu_41_p2 : STD_LOGIC_VECTOR (25 downto 0);
    signal p_Val2_s_reg_57 : STD_LOGIC_VECTOR (25 downto 0);
...
begin
    myproject_mul_muldEe_U51 : component myproject_mul_muldEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 14,
    ...
    ap_return <= p_Val2_s_reg_57(25 downto 10);

    grp_fu_41_ce_assign_proc : process(ap_ce, ap_block_pp0_stage0_11001)
    begin
