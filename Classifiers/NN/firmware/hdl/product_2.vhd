...
architecture behav of product_2 is 
    ...
    signal grp_fu_43_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal p_Val2_s_reg_59 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal grp_fu_43_ce : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;
    signal a_V_int_reg : STD_LOGIC_VECTOR (13 downto 0);
    signal w_V_int_reg : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_ce_reg)) then
                ap_return_int_reg <= p_Val2_s_reg_59(23 downto 10);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ...
            ap_return <= p_Val2_s_reg_59(23 downto 10);
        end if; 
    end process;
